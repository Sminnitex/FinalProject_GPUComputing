...
int main(int argc, char *argv[]) {
    ...
    //printMatrix(d_cscVal, nnz, nnz, "Cusparse Matrix");
    //printMatrix(transpose, m, n, "Transpose");
    //printMatrix(transposeShared, m, n, "Transpose Shared");
